...
?>
    ...
    <head>
      ...
      <meta property="og:title" content="<?= $data['judul_pakaian_adat'] ?>">
      <meta property="og:description" content="<?= $deskripsi ?>">
      <meta property="og:image" content="<?= $baseURL ?>assets/img/pakaian-adat/<?= $data['image'] ?>">
      <meta property="og:url" content="<?= $baseURL ?>pakaian-adat-detail?post_id=<?= $data['id_pakaian_adat'] ?>">
      <meta property="og:type" content="website">
      <meta property="og:site_name" content="Dokumen Digital">

      <!-- Twitter Card Meta Tags -->
      <meta name="twitter:card" content="summary_large_image">
      <meta name="twitter:title" content="<?= $data['judul_pakaian_adat'] ?>">
      <meta name="twitter:description" content="<?= $deskripsi ?>">
      <meta name="twitter:image" content="<?= $baseURL ?>assets/img/pakaian-adat/<?= $data['image'] ?>">
              ...
              <div class="page-header-inner tt-wrap">
                <div class="ph-image">
                  <div class="ph-image-inner">
                    <img src="<?= $baseURL ?>assets/img/pakaian-adat/<?= $data['image'] ?>" alt="Image">
                  </div>
                </div>
                <div class="ph-caption max-width-1000">
                  <div class="ph-categories ph-appear">
                    <a href="pakaian-adat-daerah?pin=<?= strtolower($data['daerah']) ?>" class="ph-category"><?= $data['daerah'] ?></a>
                  </div>
                  <h1 class="ph-caption-title">
                    <div class="ph-appear"><?= $data['judul_pakaian_adat'] ?></div>
                  </h1>
