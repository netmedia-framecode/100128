...
--
-- Host: localhost:3306
-- Waktu pembuatan: 22 Bulan Mei 2024 pada 01.37
-- Versi server: 8.3.0
-- Versi PHP: 8.1.10
...
--
ALTER TABLE `user_access_sub_menu`
  MODIFY `id_access_sub_menu` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `user_sub_menu`
  MODIFY `id_sub_menu` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
