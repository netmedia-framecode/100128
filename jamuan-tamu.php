  ...
  <div class="container">
    <div class="row">
      <div class="col-md-10 col-md-offset-1 col-sm-12 text-center">
        <h2 style="font-size: 80px;">Jamuan Tamu</h2>
      </div><!-- end col -->
    </div><!-- end row -->
  </div><!-- end container -->
</section><!-- end section -->
      ...
      <div class="content col-md-8">
        ...
        <div class="blog-box clearfix row">
          <div class="media-box col-md-4">
            <a href="jamuan-tamu-detail?post_id=<?= $data['id_jamuan_tamu'] ?>" title="">
              <img src="<?= $baseURL ?>assets/img/jamuan-tamu/<?= $data['image'] ?>" style="width: 100%;height: 200px; object-fit: cover;" alt="" class="img-responsive img-thumbnail"></a>
          </div><!-- end media-box -->
