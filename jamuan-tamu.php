  ...
  <div class="page-header-inner tt-wrap">
    <div class="ph-caption max-width-1000">
      <h1 class="ph-caption-title">
        <div class="ph-appear">Jamuan Tamu</div>
      </h1>
    ...
    <div class="tt-section-inner tt-wrap">
      <div class="tt-row">
        <div class="tt-col-lg-8">
          <div id="blog-list" class="bli-image-cropped">
            <?php foreach ($view_jamuan_tamu as $data) { ?>
              <article class="blog-list-item">
                <a href="jamuan-tamu-detail?post_id=<?= $data['id_jamuan_tamu'] ?>" class="bli-image-wrap" data-cursor="Read<br>More">
                  <figure class="bli-image">
                    <img src="<?= $baseURL ?>assets/img/jamuan-tamu/<?= $data['image'] ?>" data-src="<?= $baseURL ?>assets/img/jamuan-tamu/<?= $data['image'] ?>" class="tt-lazy anim-zoomin" alt="Image">
                  </figure>
                </a>
                <div class="bli-info">
                  <div class="bli-categories">
                    <a href="jamuan-tamu-daerah?pin=<?= strtolower($data['daerah']) ?>">Daerah <?= $data['daerah'] ?></a>
                  </div>
                  <h2 class="bli-title"><a href="jamuan-tamu-detail?post_id=<?= $data['id_jamuan_tamu'] ?>"><?= $data['judul_jamuan'] ?></a></h2>
                  <div class="bli-desc">
                    <?php $num_char = 250;
                  ...
                  <a href="jamuan-tamu-detail?post_id=<?= $data['id_jamuan_tamu'] ?>" class="bli-read-more tt-btn tt-btn-primary">
      ...
      <div class="tt-pagination anim-fadeinup">
        <div class="tt-pagin-prev">
          <?php if ($page_1 > 1) : ?>
            <a href="?page=<?php echo $page_1 - 1; ?>" class="tt-pagin-item magnetic-item">
              <i class="fas fa-chevron-left"></i>
            </a>
          <?php endif; ?>
        </div>
        <div class="tt-pagin-numbers">
          <?php for ($i = 1; $i <= $total_pages_1; $i++) : ?>
            <a href="?page=<?php echo $i; ?>" class="tt-pagin-item magnetic-item <?php if ($i == $page_1) echo 'active'; ?>">
              <?php echo $i; ?>
            </a>
          <?php endfor; ?>
        </div>
        <div class="tt-pagin-next">
          <?php if ($page_1 < $total_pages_1) : ?>
            <a href="?page=<?php echo $page_1 + 1; ?>" class="tt-pagin-item tt-pagin-next magnetic-item">
  ...
  <div class="tt-section padding-bottom-xlg-150">
    <div class="tt-section-inner tt-wrap">
      <div class="tt-page-nav tt-pn-stroke">
        <a href="perkawinan" class="tt-pn-link anim-fadeinup" data-cursor="<i class='fas fa-arrow-right'></i>">
          <div class="tt-pn-title">Perkawinan</div>
