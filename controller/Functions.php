    ...
    if ($action == "insert") {
      ...
      if (mysqli_num_rows($checkEmail) > 0) {
        ...
        if ($data['password'] !== $data['re_password']) {
          ...
          $en_user = str_replace(".", "", $en_user);
          $to       = $data['email'];
          $subject  = "Account Verification - Dokumen Digital";
                        ...
                        <tr>
                            ...
                            <table role='presentation' border='0' cellpadding='0' cellspacing='0' style='border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; min-width: 100%; width: 100%;' width='100%'>
                                ...
                                <td style='font-family: sans-serif; font-size: 14px; vertical-align: top;' valign='top'>
                                    ...
                                    <p style='font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;'>Terima kasih telah mendaftar di Dokumen Digital.</p>
  ...
  function forgot_password($conn, $data, $action, $baseURL)
  {
    if ($action == "update") {
      ...
      if (mysqli_num_rows($checkEmail) === 0) {
        ...
        $en_user = str_replace(".", "", $en_user);
        $to       = $data['email'];
        $subject  = "Reset password - Dokumen Digital";
        $message  = "<!doctype html>
        <html>
          <head>
              <meta name='viewport' content='width=device-width'>
...
if (isset($_SESSION["project_dokumen_digital"]["users"])) {
  ...
  function sub_menu($conn, $data, $action, $baseURL)
  {
    ...
    if ($action == "insert") {
      ...
      if (mysqli_num_rows($checkSubMenu) > 0) {
        ...
        $_SESSION["project_dokumen_digital"]["name_page"] = "' . $data['title'] . '";
  ...
  function jamuan_tamu($conn, $data, $action, $deskripsi)
  {
    $path = "../assets/img/jamuan-tamu/";
    ...
    if ($action == "insert") {
      ...
      $sql = "INSERT INTO jamuan_tamu(image,judul_jamuan,daerah,deskripsi) VALUES('$image','$data[judul_jamuan]','$data[daerah]','$deskripsi')";
    }
    ...
    if ($action == "update") {
      ...
      $sql = "UPDATE jamuan_tamu SET image='$image', judul_jamuan='$data[judul_jamuan]', daerah='$data[daerah]', deskripsi='$deskripsi' WHERE id_jamuan_tamu='$data[id_jamuan_tamu]'";
    }
    ...
    if ($action == "delete") {
      ...
      $sql = "DELETE FROM jamuan_tamu WHERE id_jamuan_tamu='$data[id_jamuan_tamu]'";
    }
  ...
  function perkawinan($conn, $data, $action, $deskripsi)
  {
    $path = "../assets/img/perkawinan/";
    ...
    if ($action == "insert") {
      ...
      $sql = "INSERT INTO perkawinan(image,judul_perkawinan,daerah,deskripsi) VALUES('$image','$data[judul_perkawinan]','$data[daerah]','$deskripsi')";
    }
    ...
    if ($action == "update") {
      ...
      $sql = "UPDATE perkawinan SET image='$image', judul_perkawinan='$data[judul_perkawinan]', daerah='$data[daerah]', deskripsi='$deskripsi' WHERE id_perkawinan='$data[id_perkawinan]'";
    }
    ...
    if ($action == "delete") {
      ...
      $sql = "DELETE FROM perkawinan WHERE id_perkawinan='$data[id_perkawinan]'";
    }
  ...
  function pakaian_adat($conn, $data, $action, $deskripsi)
  {
    $path = "../assets/img/pakaian-adat/";
    ...
    if ($action == "insert") {
      ...
      $sql = "INSERT INTO pakaian_adat(image,judul_pakaian_adat,daerah,deskripsi) VALUES('$image','$data[judul_pakaian_adat]','$data[daerah]','$deskripsi')";
    }
    ...
    if ($action == "update") {
      ...
      $sql = "UPDATE pakaian_adat SET image='$image', judul_pakaian_adat='$data[judul_pakaian_adat]', daerah='$data[daerah]', deskripsi='$deskripsi' WHERE id_pakaian_adat='$data[id_pakaian_adat]'";
    }
    ...
    if ($action == "delete") {
      ...
      $sql = "DELETE FROM pakaian_adat WHERE id_pakaian_adat='$data[id_pakaian_adat]'";
    }
