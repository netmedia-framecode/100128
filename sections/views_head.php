...
<title>
  <?= $name_website ?> <?php if (isset($_SESSION['project_dokumen_digital']['name_page'])) {
                          if (!empty($_SESSION['project_dokumen_digital']['name_page'])) {
                            echo " - " . $_SESSION['project_dokumen_digital']['name_page'];
                          }
                        } ?>
</title>
