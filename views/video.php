...
$_SESSION["project_dokumen_digital"]["name_page"] = "Video";
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="form-group">
                              <label for="id_tipe_fitur">Kategori</label>
                              <select name="id_tipe_fitur" class="form-control" id="id_tipe_fitur<?= $data['id_video'] ?>" required>
                                <option value="" selected>Pilih Kategori</option>
                                <?php $id_tipe_fitur = $data['id_tipe_fitur'];
                                foreach ($kategori as $key => $value) {
                                  $selected = ($key == $id_tipe_fitur) ? 'selected' : ''; ?>
      ...
      <div class="modal-content">
        ...
        <form action="" method="post" enctype="multipart/form-data">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="id_tipe_fitur">Kategori</label>
              <select name="id_tipe_fitur" class="form-control" id="id_tipe_fitur" required>
                <option value="" selected>Pilih Kategori</option>
