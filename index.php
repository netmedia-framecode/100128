  ...
  <div class="tt-section">
    <div class="tt-section-inner">
      ...
      <div class="text-center anim-fadeinup">
        <a href="semua-dokumen" class="tt-scrolling-btn all-works-btn" data-cursor="All<br>Works">
            ...
            <div class="scr-btn-spinner">
              <svg viewBox="0 0 500 500">
                ...
                <text dy="30" class="scr-btn-text">
                  <textPath xlink:href="#textcircle">Lihat Semua - Mulai Jelajahi -</textPath>
                </text>
              </svg>
            </div>
          </div>
  ...
  <div class="tt-section padding-top-xlg-120 padding-bottom-xlg-120 bg-white-accent-3">
    <div class="tt-section-inner">
      <div class="tt-scrolling-text" data-scroll-speed="10">
        <div class="tt-scrolling-text-inner" data-text="Informasi dokumentasi digital →">
          Informasi dokumentasi digital →
        </div>
      </div>
      <div class="tt-scrolling-text scr-text-stroke scr-text-reverse" data-scroll-speed="10">
        <div class="tt-scrolling-text-inner" data-text="Budaya tradisi Suku Dawan →">
          Budaya tradisi Suku Dawan →
        </div>
      </div>
    </div>
  </div>
